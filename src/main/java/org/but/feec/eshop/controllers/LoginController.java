...
import org.but.feec.eshop.services.AuthService;
...
public class LoginController {
    ...
    private void initializeLogos() {
        Image vutImage = new Image(Login.class.getResourceAsStream("logos/eshop-logo.png"));
    ...
    private void showPersonsView() {
        try {
            ...
            fxmlLoader.setLocation(Login.class.getResource("fxml/Persons.fxml"));
